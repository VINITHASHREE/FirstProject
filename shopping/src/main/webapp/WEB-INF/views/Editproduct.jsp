...
<%@ include file="/WEB-INF/views/Menu.jsp" %>
	<div class="container">
		<form class="form-horizontal " enctype="multipart/form-data" role="form" action="../UpdateProduct" method="post">
			...
			<input type="hidden" id="id" class="form-control" value="${product.id}" name="id" >
			<div class="form-group">
				<label for="productname" class="col-sm-3 control-label">productname</label>
				<div class="col-sm-9">
					<input type="text" id="productname" name="pn"  
						class="form-control" value="${product.pn}" autofocus>  
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select style="width: 100%;" class="form-control" value="${category.cn}" name="cn">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select style="width: 100%;" class="form-control" value="${supplier.sn}" name="sn">
